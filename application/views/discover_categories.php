...
-->
				...
				<?php foreach($categories as $category) { ?>
					...
					?>
						<div class="Discover-Body-Listing-Box">
							...
							<div class="Discover-Body-Listing-Box-Photo Fixed-Width-Photo" style="background-image: url('http://127.0.0.1:4002/ob/images/<?=$listing->data->thumbnail->small."?usecache=true"?>'), url('<?=asset_url()?>img/defaultItem.png');">									
                <a class="Discover-Body-Listing-Link" href="/store/<?=$listing->relationships->vendor->data->peerID?>/<?=$listing->data->slug?>" title="<?=$listing->data->title?>"></a>
                <?php if(isset($listing->data->freeShipping)) { ?>
								...
								<div style="display: flex; margin-top: 10px;">						
									...
									<div class="Search-Avatar-Circle" style="background-image: url('<?php echo (($listing->relationships->vendor->data->avatarHashes->small!="")) ? "http://127.0.0.1:4002/ob/images/".$listing->relationships->vendor->data->avatarHashes->small : asset_url()."img/defaultAvatar.png"?>');" title="<?=$listing->relationships->vendor->data->name?>"></div></a>
										</div>
