<div class="carousel">
	<div class="carousel-photo-stage" style="background-image: url('http://127.0.0.1:4002/ob/images/<?php echo (isset($listing->item->images)) ? $listing->item->images[0]->large : ''; ?>');">
