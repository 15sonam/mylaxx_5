...
<div class="Store-Header-Bar">
	...
	<div class="Store-Hero" style="background-image: url('<?php if($header_image) { ?>http://127.0.0.1:4002/ob/images/<?php echo (isset($profile->headerHashes)) ? $profile->headerHashes->large : ''; ?><?php } else { ?><?=asset_url()?>img/defaultHeader.png<?php } ?>');">
